...
const UserDash = () => {
    ...
    const updateUser = (e) => {
        e.preventDefault();
        const confirmUpdate = window.confirm("정말로 회원 수정을 진행하시겠습니까?");
        console.log(user);
        if (confirmUpdate) {
            ...
            axios
                .put(`http://localhost:4000/users/profile/${user.userData.Users_id}`, userDataToUpdate, {
            ...
            <Contents>
                <Sidebar greenMode={greenMode}>
                    <div>
                        ...
                        <SidebarButton greenMode={greenMode} onClick={goToUserComments}>
                            내가 쓴 댓글
                        </SidebarButton>
